...
Estado: Fases 1-8 aprovadas na bancada (5 e 6 como infraestrutura), camada de conhecimento funcionando, a
...
zero com uma cabeça só. O que os outros disseram em voz alta atravessa; o que
os outros pensam, nunca. O portão inspeciona os prompts enviados — não só as
...
que são históricos e imutáveis, então ela não pode divergir do que aconteceu.
A previsão falsificável da fase se confirmou — deslocado aprende mais que
nativo, 18,5 conceitos contra 12,0.
